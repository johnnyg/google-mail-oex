...
lang.options_unread = "Все непрочтенные";
lang.options_more_vcode = "Добавить ище код проверки (несколько аккаунтов)"
...
lang.options_unread_tooltip = "Включите, если хотите видеть количество непрочитанных не только в папке 'Входящие'";
lang.options_vcode_tooltip = "Вставьте или наберите код проверки и нажмите 'Проверить'";

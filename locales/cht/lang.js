...
// set default strings
lang.options_getverifiy  = "請求授權碼";
lang.options_saveverifiy = "套用授權碼";
lang.options_delete = "刪除";
lang.options_update = "更新間隔";
lang.options_check = "已核取";
lang.options_wait = "請稍後...";
lang.options_vcode = "授權碼";
lang.options_failverify = "授權碼不正確。";
lang.options_unread = "全部未讀";
lang.options_more_vcode = "加入更多授權碼（多個帳號）";
...
lang.options_delete_tooltip = "點選這裡移除這個帳號的郵件檢查";
...
lang.error_nocode = "<strong>尚未設定要檢查的郵件帳號</strong>, " +
  "<br/>請編輯<a href='javascript:ShowPreferences();'>偏好設定</a>";
lang.error_getfeed = "擷取訊息時發生錯誤，對象：";
